...
LIBBOARDGAME_TEST_CASE(gtp_cmd_line_init)
{
    ...
    LIBBOARDGAME_CHECK_EQUAL("arg1", string(c.get_element(2)));
    LIBBOARDGAME_CHECK_EQUAL("arg2", string(c.get_element(3)));
    ...
    LIBBOARDGAME_CHECK_EQUAL("arg3", string(c.get_element(2)));
}
...
LIBBOARDGAME_TEST_CASE(gtp_cmd_line_parse)
{
    ...
    LIBBOARDGAME_CHECK_EQUAL(3u, c.get_elements().size());
    LIBBOARDGAME_CHECK_EQUAL("11", string(c.get_element(2)));
